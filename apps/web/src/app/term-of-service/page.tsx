	...
	const lists = [
		{
			...
			desc: "",
			key_th: "1th",
			info: ["ผู้ใช้งานระบบและผู้ที่ได้รับการบันทึกข้อมูลในระบบนี้ จะต้องเป็นนักศึกษาสังกัดภาควิชาวิศวกรรมคอมพิวเตอร์ มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าธนบุรี เท่านั้น", "ผู้จัดทำระบบขอสงวนสิทธิ์ในการตรวจสอบสิทธิ์ และปฏิเสธการให้บริการแก่บุคคลภายนอกที่ไม่เกี่ยวข้อง"],
			title_eng: "User Qualifications",
			desc_eng: "",
			key_eng: "1en",
			info_eng: ["Must be a student under the Department of Computer Engineering, King Mongkut's University of Technology Thonburi (KMUTT) only.", "Developers reserve the right to verify eligibility and deny service to external parties."],
		},
		{
			id: "2",
		...
		},
		{
			...
			desc: "",
			key_th: "6th",
			info: ["ผู้จัดทำระบบขอสงวนสิทธิ์ในการแก้ไขปรับปรุงข้อกำหนดและเงื่อนไขการใช้งานนี้ได้ตลอดเวลา โดยจะประกาศการเปลี่ยนแปลงบนหน้าเว็บไซต์นี้เพื่อให้ผู้ใช้รับทราบ"],
			title_eng: "Amendments to the Terms",
			desc_eng: "",
			key_eng: "6en",
			info_eng: ["Terms can be updated at any time. Any modifications will be announced on the website."],
		},
	];
	...
	return (
		<div className="bg-light-cyan-200 text-white">
			<header className="grid grid-cols-1 grid-rows-5 justify-self-center justify-center p-20 pb-17 my-10 bg-[#03045E] border-20 border-[#00b4d8] rotate-1 shadow-[20px_20px_0px_0px_rgba(0,180,216,1)]">
				<h1 className="text-7xl font-bold col-start-1 row-start-1 row-span-3 justify-self-center">Term Of Service</h1>
				...
				<div className={default_style}>
					<div className="grid grid-cols-1 grid-rows-1">
						<div className="col-start-1 row-start-1 opacity-100 group-hover:delay-100 transition group-hover:opacity-0 duration-1000 ease-in-out">
							<p>เว็บไซต์นี้จัดทำขึ้นเพื่อเป็นระบบรวบรวมรายชื่อ รหัสนักศึกษา และอีเมลของรุ่นน้อง เพื่อประโยชน์ในการติดต่อประสานงาน และสร้างเครือข่ายภายในภาควิชาวิศวกรรมคอมพิวเตอร์</p>
						...
						<div className="col-start-1 row-start-1 opacity-0 group-hover:delay-100 transition group-hover:opacity-100 duration-1000 ease-in-out">
							<p>
								This website was created as a system to gather the names, student IDs, and emails of juniors for the purpose of coordination and networking within the Department of Computer Engineering. Please read these terms and
								conditions carefully before using the system. By accessing or registering on this system, you agree to accept all terms and conditions stated below in their entirety.
							</p>
							<p></p>
						</div>
					</div>
