...
export default function Home() {
	const lists = [
		{
			...
			key_th: "1th",
			info: ["รหัสนักศึกษา", "อีเมลมหาวิทยาลัย", "ข้อมูลการเข้าสู่ระบบ (Session Tokens) เพื่อใช้ในการคงสถานะการใช้งานบนหน้าเว็บ"],
			title_eng: "Personal Data We Collect",
			desc_eng: "We will collect personal data only as necessary, provided voluntarily with your consent, which includes:",
			key_eng: "1en",
			info_eng: ["Student ID", "University Email", "Login Information (Session Tokens)  to maintain your login status on the website."],
		},
		{
			id: "2",
			...
			desc_eng: "We collect and process your personal data under the Consent Basis for the following purposes:",
			key_eng: "2en",
			info_eng: [
		...
		},
		{
			...
			desc_eng: "We will retain your personal data for the entire duration of the activity's operations, or until you exercise your right to request the deletion of your data from the system.",
			key_eng: "3en",
			info_eng: [],
		},
		{
			...
			key_th: "4th",
			info: ["ใช้โปรโตคอล HTTPS เพื่อเข้ารหัสการรับส่งข้อมูลระหว่างเบราว์เซอร์ของผู้ใช้และเซิร์ฟเวอร์", "มีการจัดเก็บข้อมูลอย่างปลอดภัยในระบบฐานข้อมูลที่จำกัดสิทธิ์การเข้าถึง (Access Control) เฉพาะผู้ดูแลระบบที่มีหน้าที่เกี่ยวข้องเท่านั้น"],
			title_eng: "Data Security",
			desc_eng: "We implement technical security measures to protect your data as follows:",
			key_eng: "4en",
			info_eng: [
		...
		},
		{
			...
			desc_eng: "As a data subject, you hold the following legal rights under the PDPA:",
			key_eng: "5en",
			info_eng: [
		...
		},
		{
			...
			desc_eng: "This website uses Strictly Necessary Cookies solely for the purpose of remembering user login sessions. They are not used for behavioral tracking or advertising purposes.",
			key_eng: "6en",
			info_eng: [],
		},
	];
	...
	const default_style = "group z-1 p-3 m-3 mx-7 bg-[#03045E] rounded-lg rotate-0 transition-all delay-100 ease-in-out hover:scale-102 hover:rotate-1 border-b-1 hover:shadow-[10px_10px_0px_0px_rgba(0,180,216,1)] hover:my-7";
	const a = "grid grid-cols-1 grid-rows-1 group p-3 mt-30 mb-10 border-10 border-[#00b4d8] mx-5 bg-[#03045E] rounded-lg -rotate-1 shadow-[10px_10px_0px_0px_rgba(0,180,216,1)]";
	...
	return (
		<div className="bg-light-cyan-200 text-white">
			<header className="grid grid-cols-1 grid-rows-5 justify-self-center justify-center p-20 pb-17 my-10 bg-[#03045E] border-20 border-[#00b4d8] rotate-1 shadow-[20px_20px_0px_0px_rgba(0,180,216,1)]">
				<h1 className="text-7xl font-bold col-start-1 row-start-1 row-span-3">Privacy Policy</h1>
				<span className="opacity-60 col-start-1 row-start-5 justify-self-center">last updated: today</span>
			</header>
				...
				<div className={default_style}>
					<div className="grid grid-cols-1 grid-rows-1">
						<div className="col-start-1 row-start-1 opacity-100 group-hover:delay-100 transition group-hover:opacity-0 duration-1000 ease-in-out">
							<p>ให้ความสำคัญกับการคุ้มครองข้อมูลส่วนบุคคลของท่าน นโยบายความเป็นส่วนตัวฉบับนี้จัดทำขึ้นเพื่อชี้แจงรายละเอียดเกี่ยวกับการเก็บรวบรวม การใช้ และการปกป้องข้อมูลส่วนบุคคลของนักศึกษาและศิษย์เก่าที่ใช้งานระบบนี้ ให้เป็นไปตามพระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562 (PDPA)</p>
							<p>กรุณาอ่านข้อกำหนดและเงื่อนไขเหล่านี้อย่างละเอียดก่อนใช้งานระบบ การเข้าใช้งานหรือการลงทะเบียนในระบบนี้ ถือว่าท่านได้ยอมรับข้อตกลงและเงื่อนไขที่ระบุไว้ดังต่อไปนี้ทุกประการ</p>
						</div>
						<div className="col-start-1 row-start-1 opacity-0 group-hover:delay-100 transition group-hover:opacity-100 duration-1000 ease-in-out">
							<p>
								We prioritize the protection of your personal data. This Privacy Policy is established to clarify the details regarding the collection, use, and protection of the personal data of students and alumni using this system, in
								accordance with the Personal Data Protection Act B.E. 2562 (PDPA).
							</p>
							<p>Please read these terms and conditions carefully before using the system. By accessing or registering on this system, you agree to accept all terms and conditions stated below in their entirety.</p>
						</div>
					</div>
				</div>
