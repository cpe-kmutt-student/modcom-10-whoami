...
function HintFlipCard({ hintImage, isFlipped }: { hintImage: string, isFlipped: boolean }) {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 w-full h-full bg-blue-900 p-4 md:p-6 border-[2px] border-blue-900 flex flex-col items-center justify-center rounded-md shadow-lg"
        style={{
          backfaceVisibility: "hidden",
          WebkitBackfaceVisibility: "hidden",
